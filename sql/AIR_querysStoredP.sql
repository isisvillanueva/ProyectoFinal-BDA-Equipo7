...
-- query para -> sp_cambiar_estado_equipo
...
-- query para -> sp_cambiar_estado_usuario
...
-- query para -> sp_cambiar_responsable_area
...
-- query para -> sp_cerrar_asignacion_equipo
...
-- query para -> sp_cerrar_uso_clinico
...
-- query para -> sp_historial_equipo
...
-- query para -> sp_quitar_responsable_area
...
-- query para -> sp_registrar_beacon
...
-- query para -> sp_registrar_equipo
...
-- query para -> sp_registrar_mantenimiento
...
-- query para -> sp_registrar_movimiento_equipo
...
-- query para -> sp_registrar_traslado_externo
...
-- query para -> sp_registrar_uso_clinico
...
-- query para -> sp_reporte_carga_biomedica
...
-- query para -> sp_reprogramar_mantenimiento
